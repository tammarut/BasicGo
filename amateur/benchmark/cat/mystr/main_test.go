...
//! Test 2 function: TestCat, TestJoin
//! ExampleCat, ExampleJoin
//* Benchmark 2 functions =>compare
import (
	"fmt"
	"strings"
	"testing"
...
func TestCat(t *testing.T) {
	...
	xs := strings.Split(s, " ")
	result := Cat(xs)
	if result != "Shaken not stirred" {
		t.Error("Want:", "Shaken not stirred", "Got:", result)
	}
}
